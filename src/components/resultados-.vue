...
<div class="main">
        <div id="MenuPrincipal">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="documentos.html" style="color: #ffffff;">
                    <svg class="bi"><use xlink:href="#file-earmark"></use></svg>
                    Documentos
                </a>
                </li>
                <li class="nav-item">
                <a class="nav-link d-flex align-items-center gap-2" href="Cobranza.html" style="color: #ffffff;">
        ...
        <div class="general">
            ...
            <div class="general-resultados">
                ...
                <div class="pag-resultados">
                    <p style="color: white; text-align: center;">Resultados del procesamiento</p>
                </div>
            ...
            <div class="ver-resultados">
                <div class="titulos">
                    <div class="btn_volver">
                        <a class="btn btn-primary" href="generar_resultados.html" style="width: 100%;">VOLVER</a>
                    </div>
