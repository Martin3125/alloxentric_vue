...
def prepare_data(data):
    ...
    df_final['Cantidad_AccionesCobranza'] = df_final[['Sin acciones', 'Correo electronico', 'SMS', 'Whatsapp', 'Llamada por bot', 'Llamada directa', 'Acciones judiciales']].sum(axis=1)
