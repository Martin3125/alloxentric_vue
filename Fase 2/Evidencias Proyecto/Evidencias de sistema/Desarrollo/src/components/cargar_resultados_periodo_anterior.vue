...
<body>
    <header>
        ...
        <div class="card-body">
          <h5 class="card-title2">Usuario: {{ usuarioLogueado || "Invitado" }}</h5>
        </div>
        <div id="menu">
        </div>
...
export default {
  ...
  methods: {
    ...
    async getUsuario() {
      // Si hay un usuario en localStorage, lo usamos, si no, mostramos "Invitado"
      this.usuarioLogueado = localStorage.getItem("nombreUsuario") || "Invitado";
    },
  },
  mounted() {
    this.getUsuario()
